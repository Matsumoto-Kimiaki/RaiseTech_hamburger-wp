...
<html lang="ja">
      ...
      <header>
        <div class="l-header u-font-grey">
          <nav class="p-global-navigation">
            <h1 class="p-global-navigation__logo-title u-font-roboto"><a href="index.html">Hamburger</a></h1>
            <h3 class="p-global-navigation__logo-menu js-menu u-font-roboto">Menu</h3>
            <form class="p-search-form" action="#" method="get" name="search-form">
              <input type="search" class="p-search-form__box c-box fas fa-search" data-fa-transform="left-20" value="&#xf002;" />
      ...
      <main>
        <div class="l-main">
          ...
          <div class="p-hero--page u-mt">
            ...
            <!-- 導入 -->
            <div class="p-introduction--single u-mt">
              <h2>見出しh2</h2>
              <p>
            ...
            <div class="p-eyecatch u-mt">
              ...
              <!-- ライト画像 -->
              <figure class="p-eyecatch__right">
                <figcaption class="p-eyecatch__right__caption">
                  <p>
                    テキストが入ります テキストが入ります テキストが入ります テキストが入ります テキストが入ります テキストが入ります テキストが入ります テキストが入ります テキストが入ります テキストが入ります テキストが入ります テキストが入ります テキストが入ります テキストが入ります テキストが入ります テキストが入ります テキストが入ります
                    テキストが入ります テキストが入ります テキストが入ります テキストが入ります テキストが入ります テキストが入ります テキストが入ります テキストが入ります テキストが入ります テキストが入ります テキストが入ります テキストが入ります テキストが入ります テキストが入ります テキストが入ります テキストが入ります テキストが入ります
                    テキストが入ります テキストが入ります テキストが入ります テキストが入ります
  ...
  &lt;/html&gt;
            ...
            <!-- ボタン -->
            <div class="p-button-wrapper u-mt">
              <button class="c-button">ボタン</button>
            </div>
              
            <!-- テキスト -->
            <div class="c-text u-mt">
